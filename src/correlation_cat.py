...
def multi_corr(col1, col2=train_labels['attack_cat'], df=train_features):
...
def corr(col1, col2=train_labels['attack_cat'], df=train_features):
...
clf.fit(X_train, y_train['attack_cat'])

# Predict the classes for the testing data
y_pred = clf.predict(X_test)
# Evaluate the accuracy of the classifier
accuracy = accuracy_score(y_test['attack_cat'], y_pred)
error = 100 - (accuracy * 100)
print("attack_cat")
print("Error percentage:", error)

# Calculate the confusion matrix and classification report
cm = confusion_matrix(y_test['attack_cat'], y_pred)
print("Confusion matrix:")
#print(cm)
y_pred = train.relabel(y_pred)
y_test['attack_cat'] = train.relabel(y_test['attack_cat'])
print("Classification report:")
print(classification_report(y_test['attack_cat'], y_pred))
